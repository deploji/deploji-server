...
func main() {
	...
	authRouter.HandleFunc("/templates/{id}/survey", controllers.GetSurvey).Methods("GET")
	authRouter.HandleFunc("/templates/{id}/survey", controllers.SaveSurvey).Methods("POST")
	authRouter.HandleFunc("/templates/{id}/survey", controllers.SaveSurvey).Methods("PUT")
	authRouter.HandleFunc("/templates/{id}/survey", controllers.DeleteSurvey).Methods("DELETE")
	authRouter.HandleFunc("/templates/{id}/survey/inputs", controllers.GetSurveyInputs).Methods("GET")
	authRouter.HandleFunc("/templates/{id}/survey/inputs", controllers.SaveSurveyInput).Methods("POST")
	authRouter.HandleFunc("/templates/{id}/survey/inputs/{inputId}", controllers.GetSurveyInput).Methods("GET")
	authRouter.HandleFunc("/templates/{id}/survey/inputs/{inputId}", controllers.SaveSurveyInput).Methods("PUT")
	authRouter.HandleFunc("/templates/{id}/survey/inputs/{inputId}", controllers.DeleteSurveyInput).Methods("DELETE")
	authRouter.HandleFunc("/templates/{id}/notifications", controllers.GetTemplateNotifications).Methods("GET")
	authRouter.HandleFunc("/templates/{id}/notifications", controllers.SaveTemplateNotification).Methods("PUT")
	authRouter.HandleFunc("/templates/{id}/notifications", controllers.UpdateTemplateNotification).Methods("PATCH")
	...
	authRouter.HandleFunc("/applications/{id}/notifications", controllers.UpdateApplicationNotification).Methods("PATCH")
	...
	adminRouter.HandleFunc("/projects/{id}/notifications", controllers.GetProjectNotifications).Methods("GET")
	adminRouter.HandleFunc("/projects/{id}/notifications", controllers.SaveProjectNotification).Methods("PUT")
	adminRouter.HandleFunc("/projects/{id}/notifications", controllers.UpdateProjectNotification).Methods("PATCH")
