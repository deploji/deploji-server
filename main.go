...
func main() {
	...
	authRouter.HandleFunc("/deployments", controllers.GetDeployments).Methods("GET")
	authRouter.HandleFunc("/deployments", controllers.SaveDeployments).Methods("POST")
	authRouter.HandleFunc("/deployments/latest", controllers.GetLatestDeployments).Methods("GET")
	authRouter.HandleFunc("/deployments/{id}", controllers.GetDeployment).Methods("GET")
	authRouter.HandleFunc("/deployments/{id}/logs", controllers.GetDeploymentLogs).Methods("GET")
	authRouter.HandleFunc("/jobs", controllers.GetJobs).Methods("GET")
	authRouter.HandleFunc("/jobs", controllers.SaveJobs).Methods("POST")
	authRouter.HandleFunc("/jobs/latest", controllers.GetJobs).Methods("GET")
